  ...
  <div class="app">
    ...
    <AppHeader style="height: 60px" fixed>
      ...
      <b-link class="navbar-brand" to="/">
        <img style="margin-left: -10px" class="navbar-brand-full" src="/img/brand/logo.jpg" width="60" height="60" alt="Fun gifs Logo">
        <img class="navbar-brand-minimized" src="/img/brand/logo-min.jpg" width="30" height="30" alt="CoreUI Logo">
      </b-link>
    ...
    <TheFooter>
      ...
      <div class="ml-auto">
        <span class="mr-1">© 2018 Fun Gifs официальный сайт. Все права защищены.</span>
      </div>
    </TheFooter>
  </div>
</template>
