        ...
        <div class="container py-0 pb-lg">
            <div class="row justify-content-between align-items-center">
                <div class="col-lg-5 mb-5 mb-lg-0">
                    <h1 class="text-white font-weight-light">Отзывы о нас</h1>
                    <p class="lead text-white mt-4">Напишите, что вы думаете о нас<br> Email: <a style="color: #b3ffec;" href="mailto:fun.gifs.official@gmail.com">fun.gifs.official@gmail.com</a></p>
